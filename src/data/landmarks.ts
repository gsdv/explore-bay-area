...
export const landmarks: Landmark[] = [
  ...
  { id: 'palace', name: 'Palace of Fine Arts', kind: 'rotunda', lat: 37.8029, lng: -122.4484, area: 'Marina', blurb: 'A Roman-style rotunda built for the 1915 Panama-Pacific Exposition, kept because the city loved it too much to tear down.', tags: ['icon', 'culture'] },
  ...
  { id: 'pier39', name: 'Fisherman\'s Wharf & Pier 39', kind: 'wharf', lat: 37.8087, lng: -122.4098, area: 'North Beach', blurb: 'Sea lions, sourdough bowls and the Musée Mécanique. Touristy, but the sea lions are worth it.', tags: ['culture', 'food'] },
