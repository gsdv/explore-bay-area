...
export const quests: Quest[] = [
  ...
  },
  {
    ...
    stops: [
      ...
      { id: 'transamerica', name: 'Transamerica Pyramid', lat: 37.7952, lng: -122.4028, ref: { kind: 'landmark', id: 'transamerica' }, view: { dist: 16, yaw: -0.5 }, todo: 'Sit in the redwood grove at its base.' },
      { id: 'ferrybuilding', name: 'Ferry Building', lat: 37.7955, lng: -122.3937, ref: { kind: 'landmark', id: 'ferrybuilding' }, view: { dist: 9, yaw: 2.2 }, todo: 'Late lunch inside.' },
